    ...
    def initialize(self) -> None:
        with self.connect() as db:
            with db.cursor() as cur:
                ...
                """)
                cur.execute("""
                    CREATE INDEX IF NOT EXISTS idx_job_executions_workflow_started
                    ON job_executions(workflow_id, started_at DESC)
                """)
                cur.execute("""
                ...
                """)
                cur.execute("""
                    CREATE INDEX IF NOT EXISTS idx_provider_quota_time
                    ON provider_quota_snapshots(provider, captured_at DESC)
                """)
                cur.execute("""
                ...
                cur.execute("""
                    CREATE TABLE IF NOT EXISTS project_progress_snapshots (
                        ...
                        production_progress DOUBLE PRECISION,
                        project_progress DOUBLE PRECISION,
                        confidence TEXT NOT NULL,
                        code_score DOUBLE PRECISION,
                        ui_ux_score DOUBLE PRECISION,
                        assets_score DOUBLE PRECISION,
                        tests_score DOUBLE PRECISION,
                        stability_score DOUBLE PRECISION,
                        release_score DOUBLE PRECISION,
